...
class _PeeScreenState extends State<PeeScreen> with TickerProviderStateMixin {
  ...
  getdata() async {
    ...
    prefs.setString('last_route', "/pee");
...
// Select for Time
  ...
  List List_content = [
    "Kegels help you control the flow of urine. ",
    "Peeing can’t prevent pregnancy, though it may reduce the risk of infection. ",
    "Viruses and bacteria can, of course, make their way past mucous membranes before or even after you pee, but it’s still worth flushing out what you can. If the meatus of the vulva, or the meatus of the penis, come in contact with fecal bacteria from a nearby anus, there’s a risk of getting a urinary tract infection, or a UTI. To prevent this, wash between anal and vaginal sex, speak up when you think there’s fecal bacteria on the move, wipe front to back, use condoms and pee after sex. YES it may be difficult to pee after sex. That’s because during orgasm, the body releases vasopressin, a hormone meant to stop you from peeing. -Your body is trying to conserve water, and vasopressin does it by "
        "\n• Constricting the blood vessels so urine stays on the body. "
        "\n• By helping the kidneys reabsorb the water in the urine. ",
    "Urine exits the body through a hole called the meatus (not the vagina)- "
        "\n• But in 1 out of 200 males, and 1 in 500,000 females, it’s in another location –the shaft, scrotum, or vagina. This is a condition called hypospadias, and it can have adverse effects on sex and reproduction. ",
    "Why peeing burns? (Dysuria or painful peeing) Causes may be any of the following: "
        "\n• Obstructive Uropathy- something blocking the flow out, like an enlarged prostate. Solution is a prostate massage. "
        "\n• Kidney Stones- a solid mass or masses that are difficult or impossible to pass. "
        "\n• Urinary Tract Infections- that can become bladder infections and kidney infections, so be careful during anal play. "
        "\n• Urethral stricture- basically a narrow urethra from inflammation or scarring, so people who have penile implants are at risk. "
        "\n• Urethritis, Prostatitis, Vaginitis, Epididymitis, Pyelonephritis- are other kinds of inflammation. "
        "\n• Cancer- is a group of diseases involving abnormal call growth with the potential to invade or spread to other parts of the body. These contrast with benign tumors, which do not spread. "
        "\n• Chlamydia, Gonorrhea- are sexually transmitted infections. ",
    "Precum or pre-ejaculate- is a clear droplet of fluid produced by the Cowper’s gland to neutralize any urine left in the urethra so it’s safer for sperm. ",
    "Urine is made mostly of water, with some salt, proteins, hormones, and metabolites. ",
    "Squirting is different than peeing. Urine comes from the bladder and out the meatus. Squirting (Gushing, Female ejaculation, etc.) comes out the paraurethral glands, below the meatus. ",
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final TextSpan textSpan = HTML.toTextSpan(
      ...
      (isinfoLoading == true
          ? ''
          : PeeTechniqueModel!.data!.technique!),
...
//                                     : SizedBox.shrink()),
  ...
  startWatch4() {
    ...
    setState(() {
      ...
      elapsedTime = "00";
      watch.start();
      timer = Timer.periodic(const Duration(milliseconds: 100), updateTime4);
    });
  }
  ...
  Future<dynamic> pee_technique_API({required BuildContext context,required String method}) async {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      CommonWidget().showToaster(msg: PeeTechniqueModel!.message!);
