...
import 'model/AlarmdeleteModel.dart';
...
class _KegelScreenState extends State<KegelScreen>
              ...
              if (counter >= 4) {
                ...
                if (_kegel_controller.sets == 3) {
                  ...
                  _scaleDialog(
                      context: context,
                      message:
                      "Congratulations! You have completed your daily sessions!");
  ...
  done_animation() {
    ...
    _animationController_shadow1!.forward();
    _animation_shadow1 =
    Tween(begin: 75.0, end: 0.0).animate(_animationController_shadow1!)
      ..addStatusListener((status) {
        print(status);
        if (status == AnimationStatus.completed) {
          // print("elapsedTime");
    ...
    _animation_shadow2 =
    Tween(begin: 80.0, end: 75.0).animate(_animationController_shadow2!)
      ..addStatusListener((status) {
        if (shadow_animation_pause == true) {}
        // print(status);
        // if (status == AnimationStatus.completed) {}
  ...
  init() async {
    ...
    prefs.setString('last_route', "/kegel");
  ...
  Future getdata() async {
    ...
    setState(() {
      selected_time = DateFormat('HH:mm').format(DateTime.now());
    });
    setState(() {});
    await _kegel_controller.Kegel_get_API(context);
    await Kegel_technique_API(
  ...
  List List_content = [
    "What are pelvic floor (PC) muscles: Picture of pelvic floor muscles \n•A hammock stretched out between the legs, from the pubic bone up to the tailbone. They support and control the genitals, urethra, and anus.",
    "To locate these muscles: "
        "\nGo and pee then stop and release stop and release. The contraction you do to stop urination, that a Kegel. The clench you feel to stop the stream of urine, is your pelvic floor muscles, a setoff your perineal muscles, voluntarily contracting. Only use this method to find the location of your pelvic floor muscles. Do not do this every time you urinate. "
        "\n• Vibrating means Hold "
        "\n• Non-Vibrating means Relax "
        "\n• When the Vibration gets stronger, squeeze harder",
    "How to perform a Kegel: "
        "\n• Try to shorten or withdraw your penis inwards towards your body, imagine you stop the flow of urine, and tighten your anus as if you were trying to stop gas from passing; while keeping your buttocks relaxed."
        "\n• Using a high. Pitch voic “eeeeeeeeeek” while performing a Kegel exercise, can help to better perform the exercise."
        "\n• Women – Insert a clean finger into your vagina and try to tighten the walls around it. That’s a Kegel! (it will help if you buy Kegel balls, do not insert the Kegel balls into your anus!) We recommend the Lelo balls. plus put link below."
        "\n• Men- Place a towel or tissue on top of your erect penis. Using your pelvic floor muscles, elevate your penis. That’s a Kegel.",
    "Kegels are helpful in many ways"
        "\n• Last longer in bed by controlling your ejaculation."
        "\n• Preventing urge to urinate and stress urination."
        "\n• Supporting the bowels."
        "\n• Enabling a more comfortable pregnancy, labor and delivery, and recovery."
        "\n• Enhancing pleasurable sensations for you and your partners."
        "\n• Improving circulation and function through the groin, consequently."
        "\n• Increasing Lubrication."
        "\n• Producing more athletic erections."
        "\n• Mediating rapid ejaculation."
        "\n• Having more control of your genitals.",
    "Reverse Kegel:"
        "\n• Using a low pitch voice “ooooooooooooh” while performing a Reverse Kegel exercise can help to better perform the exercise."
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final TextSpan textSpan = HTML.toTextSpan(
      context,
      (isinfoLoading == true ? '' : KegelTechniqueModel!.data!.technique!),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            if (_kegel_controller.kegelGetAlarmModel!.error! !=
                                true) {
                              mohit = _kegel_controller
                                  .kegelGetAlarmModel!.data!
                                  .firstWhereOrNull((element) =>
                              element.alarmTime == formattedDate);
                              print("mohit");
                              // print(mohit.alarmTime);
                            }
                            if (_kegel_controller.kegelGetModel!.error ==
                                false &&
                                                                  ...
                                                                  child: Column(
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                        Text(
                                                                          "You are ahead of your schedule. To complete your session now your upcoming alarm will be deleted. Press Continue to Proceed",
                                                                          textAlign:
                                                                          TextAlign.center,
                                                                          style: FontStyleUtility.h16(
                          ...
                          child: Column(
                            children: [
                              ...
                              Obx(() => _kegel_controller
                                ...
                                shrinkWrap: true,
                                padding: EdgeInsets.zero,
                                itemCount: _kegel_controller
                                    .kegelGetAlarmModel!.data!.length,
                                              ...
                                              trailing: IconButton(
                                                  ...
                                                  onPressed: () {
                                                    Alarm_delete_API(
                                                        context:
                                                        context,
                                                        alarm_id: _kegel_controller
                                                            .kegelGetAlarmModel!
                                                            .data![
                                                        index]
                                                            .id!);
                                                    // deleteAlarm(
                                                    // _kegel_controller.kegelGetAlarmModel!.data![index].id!.toString());
                                                  }),
                                              // Container(
                                              //   width: 20,
                                              //   child: Transform.scale(
  ...
  Future<dynamic> Alarm_post_API(BuildContext context) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (alarmPostModel!.error == false) {
        _kegel_controller.Kegel_alarm_get_API(context);
  ...
  Future<dynamic> Alarm_delete_API(
      {required BuildContext context, required String alarm_id}) async {
    debugPrint('0-0-0-0-0-0-0 username');
    // try {
    //
    // } catch (e) {
    ...
    var url = (URLConstants.base_url + URLConstants.kegel_alarm_delete);
    print("url : $url");
    print("body : $data");
  ...
  Future<dynamic> Kegel_technique_API(
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      CommonWidget().showToaster(msg: KegelTechniqueModel!.message!);
